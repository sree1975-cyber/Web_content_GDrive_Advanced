    ...
    try:
        ...
        with st.expander("ℹ️ About Web Content Manager", expanded=False):
            ...
            <div style="padding: 1rem;">
                ...
                <p>For detailed instructions, see the <a href="https://github.com/<your-repo>/web_content_gdrive_advanced/blob/main/USER_GUIDE.md" target="_blank">User Guide</a>.</p>
            </div>
            """, unsafe_allow_html=True)
